...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function selectFolderRoot(event) {
	      if (event.target.getAttribute('class') === 'liSpan') {
	        var objKey = getObjKey(event, 'folderRoot');
	        var selectedObj = {};
	        //set and clear selection status for root
	        for (var i = 0; i < this.props.folderRoots.length; i++) {
	          if (this.props.folderRoots[i].key === objKey) {
	            ...
	            for (var j = 0; j < this.props.folderRoots[i].contents.length; j++) {
	    ...
	    value: function openContextMenu(event) {
	      ...
	      if (event.target.className === 'folderLevel') {
	        ...
	        var objKey = getObjKey(event, 'cMenu');
	    ...
	    value: function cMenuFieldFocus(event) {
	      var objKey = getObjKey(event, 'cMenu2');
	      var trail = findSelectionWrapper(this.state.selectionMap[0], objKey, false, false, false);
	    ...
	    value: function componentWillUpdate() {
	      var folderTeirList = document.querySelectorAll('.folderLevel');
	      scrollPositions = [];
	      for (var i = 0; i < folderTeirList.length; i++) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'div',
	            { className: 'folderRootsDiv' },
	            _react2.default.createElement(
	              'ul',
	              { id: 'folderRoots', onClick: this.selectFolderRoot.bind(this) },
	              this.props.folderRoots.map(function (folderRoot) {
	                return _react2.default.createElement(
	                  'li',
	                  { key: folderRoot.key, className: folderRoot.selectStatus + ' folderLi' },
	                  _react2.default.createElement(
	                    'span',
	                    { className: 'liSpan' },
	                    folderRoot.name
